...
It is a plugin to work with viewing and editing Google Cloud Storage files in Jupyterlab

This extension is composed of a Python package named `gcs_jupyter_plugin`
for the server extension and a NPM package named `gcs_jupyter_plugin`
...
folder is located. Then you can remove the symlink named `gcs_jupyter_plugin` within that folder.
test
